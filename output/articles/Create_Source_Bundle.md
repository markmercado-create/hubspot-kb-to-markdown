...
4. Browse to your GP instance credential JSON file and then click **Update** button   
   ![gp-cred-upload](https://20462040.fs1.hubspotusercontent-na1.net/hubfs/20462040/knowledge-base-files/webfm/gp-cred-upload.png)
...
6. Input the **Resource Filter ID** for each source file and **Uncheck Download Translations to WebFM**
   ...
   - WebFM may suggest some resource filter ID based on file extension, but you can change it based on your files.  
     ![upload-gp-source](https://20462040.fs1.hubspotusercontent-na1.net/hubfs/20462040/knowledge-base-files/webfm/upload-gp-source.png)

 7. Click **Run GP  
![gp-import-output](https://20462040.fs1.hubspotusercontent-na1.net/hubfs/20462040/knowledge-base-files/webfm/gp-import-output.png)**   
