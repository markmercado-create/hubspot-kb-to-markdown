...
[Download the resources (Right click -> Save link as)](https://kb.strakertranslations.com/hubfs/knowledge-base-files/resources.zip). Unzip it and we will place this later under `src/main` for our tutorial projects.
